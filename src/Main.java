...
Объявите переменную n и, путем математических операций над m получите и присвойте переменной n цифру, которая находится в центре значения из переменной m.
 */
